...
@section("main")
                    ...
                    <table class="table-shopping-cart">
                        ...
                        @if(session("cart") != null)
                            ...
                            <tr class="table-row">
                                ...
                                <td class="column-3">{{ number_format($product["Price"]) }} VND</td>
                                <td class="column-4">
            ...
            <form method="post" action="">
                ...
                <div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
                    ...
                    <div class="flex-w flex-sb-m p-b-12">
                        ...
                        <span class="m-text21 w-size20 w-full-sm" name="subtotal">
    ...
    {{--						</span>--}}
                            ...
                            <div class="small rs2-select2 rs3-select2 rs4-select2 bo4 of-hidden w-size21 m-t-8 m-b-12">
                                <select class="selection-2" name="shipping">
                                    <option value="0">Giao hàng nhanh 24h</option>
                                    <option value="1">Giao hàng chuẩn (3-5 ngày)</option>
                                </select>

                                <span class="s-text19" name="shipping-cost">50.000 VND</span>
                            </div>
    ...
    {{--                        </div>--}}
                    ...
                    <div class="flex-w flex-sb-m p-t-26 p-b-30">
                        ...
                        <span class="m-text21 w-size20 w-full-sm" name="total-order">
                            {{ number_format($total+50000) }} VND
                        </span>
                    </div>
